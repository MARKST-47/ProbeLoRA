...
class ExperimentConfig:
    ...
    # Pulls from cluster background environment variable, falls back to anonymous safe string
    wandb_entity: str = os.getenv("WANDB_ENTITY", "default-anonymous") 
